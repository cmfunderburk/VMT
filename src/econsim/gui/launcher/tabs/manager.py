...
class TabManager:  # pragma: no cover - GUI coordination class
    ...
    def __init__(self, tab_widget, parent=None):
        ...
        # Event callbacks
        self._on_tab_activated: Callable[[str], None] | None = None
        self._on_tab_deactivated: Callable[[str], None] | None = None
        self._on_tab_added: Callable[[str], None] | None = None
        self._on_tab_removed: Callable[[str], None] | None = None
    ...
    def register_tab(self, tab: AbstractTab, index: int | None = None) -> None:
    ...
    def get_tab(self, tab_id: str) -> AbstractTab | None:
    ...
    def broadcast_message(
        self, message: str, data: Any = None, exclude_tab: str | None = None
    ) -> None:
