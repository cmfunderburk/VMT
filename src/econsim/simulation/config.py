...
class SimConfig:
    ...
    Attributes:
        ...
        agent_count: Number of agents to create with random spawn positions
    ...
    name: str | None = None  # Test/simulation name for file naming
    ...
    def create_simulation(self):
        """Create a simulation instance from this configuration."""
        from .coordinator import SimulationCoordinator

        return SimulationCoordinator.from_config(self)
