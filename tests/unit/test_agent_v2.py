"""Canonical Agent unit tests (clean rewrite after legacy removal).

Coverage:
 - Construction defaults & inventory initialization
 - Utility aggregation & current utility calculation
 - Inventory deposit/withdraw edge cases (location & insufficiency)
 - Convenience methods (totals, flags, co-location)
