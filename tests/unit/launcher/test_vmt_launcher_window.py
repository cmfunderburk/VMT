...
class TestVMTLauncherWindow:
    ...
    def test_vmt_launcher_window_import(self):
        ...
        from econsim.gui.launcher.app_window import VMTLauncherWindow
    ...
    def test_vmt_launcher_window_methods_exist(self):
        ...
        for method_name in expected_methods:
            ...
            assert callable(
                getattr(VMTLauncherWindow, method_name)
            ), f"Method not callable: {method_name}"

    def test_vmt_launcher_window_module_functions(self):
        """Test module-level utility functions."""
        from econsim.gui.launcher.app_window import _launcher_modules_available
    ...
    @patch("econsim.gui.launcher.app_window", False)
