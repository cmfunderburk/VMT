...
from econsim.gui.launcher.types import TestConfiguration
...
def test_card_model_none_file():
    ...
    model = TestCardModel(id=1, label="Test Card", mode="framework", file=None, order=1, meta={})
...
def test_build_card_models_snapshot_stability():
    ...
    def stable_source():
        return [
            ...
            TestConfiguration(
                id=2, label="Sparse Long-Range", mode="framework", file=None, meta={}
            ),
            TestConfiguration(
                id=3, label="Dense Short-Range", mode="framework", file=None, meta={}
            ),
        ]
...
def test_card_model_immutable():
    ...
    model = TestCardModel(id=1, label="Test", mode="framework", file=None, order=1, meta={})
